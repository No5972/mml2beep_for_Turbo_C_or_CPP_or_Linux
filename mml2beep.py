...
def main():
    ...
    mml = "改成MML乐谱 在这运行 https://c.runoob.com/compile/9"
    res = MmlParser().parse(mml)[0]
    n = 20
    res_parts = [res[i:i+n] for i in range(0, len(res), n)]
    print("#define NOTESCONUT " + str(len(res)))
